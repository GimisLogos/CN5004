 ...
 * ΑΡΜΟΔΙΟΤΗΤΕΣ:
 * 1. Μηνιαία προβολή ραντεβού
 * 2. Πλοήγηση μηνών (προηγούμενος, επόμενος, σήμερα)
 * 3. Εμφάνιση αριθμού ραντεβού ανά ημέρα
 * 4. Εμφάνιση λεπτομερειών ραντεβού επιλεγμένης ημέρας
 *
 * ΚΥΡΙΕΣ ΜΕΘΟΔΟΙ & ΓΡΑΜΜΕΣ:
 *
 * refreshCalendar()   - Δημιουργία ημερολογίου (γραμμή ~75)
 * createDayCell()     - Δημιουργία κελιού για κάθε ημέρα (γραμμή ~117)
 * showDayAppointments()- Εμφάνιση ραντεβού επιλεγμένης ημέρας (γραμμή ~155)
 * previousMonth()     - Προηγούμενος μήνας (γραμμή ~54)
 * nextMonth()         - Επόμενος μήνας (γραμμή ~60)
 * today()             - Επιστροφή στον τρέχοντα μήνα (γραμμή ~66)
 */
